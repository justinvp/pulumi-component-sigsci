...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("sigsci");
			params.setVersion("3.7.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NpZ25hbHNjaWVuY2VzL3NpZ3NjaSIsInZlcnNpb24iOiIzLjcuMCJ9fQ=="), c => c.charCodeAt(0)));
